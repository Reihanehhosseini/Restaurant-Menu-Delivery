  ...
  return (
    <header className="flex flex-col items-center gap-7 px-1.25 ">
      <div className="space-y-3" data-aos="fade-up">
        <h1 className="text-center text-2xl iphon11:text-3xl font-medium tracking-[0.18em] text-white font-myfont! sm:text-4xl sm:tracking-[0.26em] md:text-5xl">
          ROYAL TASTE
        </h1>
        <div className="flex items-center justify-center gap-3 sm:gap-4">
          <span className="h-px w-8 bg-linear-to-r from-lightGold to-gold sm:w-10" />
          <p className="text-[11px] font-medium tracking-[0.5em] text-gold sm:text-xs">
            RESTAURANT
          </p>
          <span className="h-px w-8 bg-linear-to-r from-lightGold to-gold sm:w-10" />
        </div>
      ...
      <p
        ...
        data-aos="fade-up"
      >
        Exceptional food, unforgettable experience
      </p>
